...
drops below the saturation pressure of water. 
In a first and very short stage, the liquid stays in a metastable state.
%trsltx-split
It can also happen in this stage that the pressure becomes negative (it is
...
Because the stiffened gas law is
...
This phenomenon is called \textsl{cavitation}.
%trsltx-split
For a physical description of the cavitation, we refer to the book of Franc \(\&\)
...
(\ref{slc}) or (\ref{abgralcons}).
We first exhibit one of these test
